...
android {
    ...
    // Чтение ключа из local.properties (игнорируется в Git)
    val localProperties = Properties()
    val localPropertiesFile = rootProject.file("local.properties")
    if (localPropertiesFile.exists()) {
        localPropertiesFile.inputStream().use { localProperties.load(it) }
    }
    val yandexMapApiKey = localProperties.getProperty("YANDEX_MAP_API_KEY") ?: ""
    ...
    defaultConfig {
        ...
        // Добавляем ключ в BuildConfig на этапе сборки
