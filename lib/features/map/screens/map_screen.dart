...
const _fixedRouteFrom = Point(latitude: 56.6530568, longitude: 124.7345052);
const _fixedRouteTo = Point(latitude: 56.66226440, longitude: 124.7082745);
...
class _MapScreenState extends State<MapScreen> {
  ...
  void _updateCamera() {
    ...
    final routePoints = _displayRoutePoints();
    ctrl.moveCamera(
  ...
  _ResolvedRoutePoints _displayRoutePoints() {
    return const _ResolvedRoutePoints(
      from: _fixedRouteFrom,
      to: _fixedRouteTo,
    );
  }
